...
def test_parse():
    ...
    assert parse("38006F45291200") == [OperatorPacket(1, 6, [LiteralPacket(6, 10), LiteralPacket(2, 20)])]
    assert parse("EE00D40C823060") == [OperatorPacket(7, 3, [LiteralPacket(2, 1), LiteralPacket(4, 2), LiteralPacket(1, 3)])]
